...
engine = create_engine('sqlite:///solar_eclipse.db', echo=True)
sqlite_connection = engine.connect()
...
engine = create_engine('sqlite:///Asteroid_orbit.db', echo=True)
sqlite_connection = engine.connect()
...
engine = create_engine('sqlite:///near_earth_comets.db', echo=True)
sqlite_connection = engine.connect()
sqlite_table = "Comets"
