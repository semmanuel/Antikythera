...
class Body(object):
    ...
    def display(self):
        ...
        pygame.draw.circle(surface, BLACK, (int(self.last_position[0]), int(self.last_position[1])),
                           10)  # (drawLayer, color, (coordinates), radius)

        # draw trail (Comment this line out to remove trails)
        pygame.draw.circle(surface, RED, (int(self.last_position[0]), int(self.last_position[1])),
                           10)  # (drawLayer, color, (coordinates), radius)

        # draw new object location
        pygame.draw.circle(surface, self.color, (int(self.position[0]), int(self.position[1])),
                           10)  # (drawLayer, color, (coordinates), radius)
